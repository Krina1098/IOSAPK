...
@WebServlet("/UserEditProfilePic")
@MultipartConfig
public class UserEditProfilePic extends HttpServlet {
	/**
	 * 
	 */
	...
	public void doMethod(HttpServletRequest request,HttpServletResponse response) throws IOException, ServletException, SQLException
	{
		...
		InputStream img=null;
	     ...
	     int row;
	     stmt=conn.prepareStatement("Update APPUSER set IMAGE=? where USERNAME=?");
	     stmt.setBlob(1, img);
	     ...
	     row=stmt.executeUpdate();
			...
			if(row>0)
			{
				...
				try {
					response.getWriter().println("<!DOCTYPE html>\r\n" + 
					 		...
					 		"      alert(\"User Profile Pic Updated Successfully!!!\");\r\n" + 
					 		"    </script>\r\n" + 
					 		"\r\n" + 
					 		"  </body>\r\n" + 
					 		"</html>");
			...
			{
				RequestDispatcher rd= request.getRequestDispatcher("UserEditProfile.jsp");
				try {
					response.getWriter().println("<!DOCTYPE html>\r\n" + 
					 		"<html lang=\"en\" dir=\"ltr\">\r\n" + 
					 		"  <head>\r\n" + 
