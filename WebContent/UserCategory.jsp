			       ...
			       <% 
                     try
					{
                    	  ...
                    	  PreparedStatement state=null;
                    	  	...
                    	  	stmt=conn.prepareStatement("SELECT * FROM APPLICATION");
  						  ...
  						  { 
   							...
   							{%> 
    	 						 ...
    	 						 <tr>
    	 						 <td style="color:white; font-weight:bold; latter-spacing:1px;font-size:35px;"> <b> COMMENT </b> </td>
    	 						 </tr>
    	 						 <%
    	 						    state=conn.prepareStatement("SELECT * FROM SYSTEM.REVIEW where APPNAME=? AND VERSION=?");
    	 						    state.setString(1,AppName);
    	 						    state.setString(2,Version);
    	 						    ResultSet rest=state.executeQuery();
    	 						    while(rest.next())
    	 						    {%>
    	 						        <tr>
    	 						            <td style="color:white; font-weight:bold; latter-spacing:1px;font-size:15px;"> <b> Name: </b> </td>
    	 						            <td  style="color:white; font-weight:bold; latter-spacing:1px;font-size:15px;"><b><%=rest.getString("NAME") %></b></td>
       	 						        </tr>
       	 						        <tr>
    	 						            <td style="color:white; font-weight:bold; latter-spacing:1px;font-size:15px;"> <b> Rating: </b> </td>
    	 						            <td  style="color:white; font-weight:bold; latter-spacing:1px;font-size:15px;"><b><%=rest.getString("RATING") %></b></td>
       	 						        </tr>
       	 						         <tr>
    	 						            <td style="color:white; font-weight:bold; latter-spacing:1px;font-size:15px;"> <b> Comment: </b> </td>
    	 						            <td  style="color:white; font-weight:bold; latter-spacing:1px;font-size:15px;"><b><%=rest.getString("COMENT") %></b></td>
       	 						        </tr>
						...
						<%}
    	 						 ...
    	 						 <%
    	 						    state=conn.prepareStatement("SELECT * FROM REVIEW where APPNAME=? AND VERSION=?");
    	 						    state.setString(1,AppName);
    	 						    state.setString(2,Version);
    	 						    ResultSet rest=state.executeQuery();
    	 						    while(rest.next())
